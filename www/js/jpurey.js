...
Array.prototype.hash = function(h,g=[]) { g.forEach.call(h.replace(window.location.origin+'/', '').split('/'), function(a,i){ g[i] = a; }); return g; };
...
Element.prototype.on = function(name, callback) { this.addEventListener(name, callback, false); return this; };
Element.prototype.off = function(name, callback) { this.removeEventListener(name, callback, false); return this; };
